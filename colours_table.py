...
def color_difference(rgb1, rgb2):
    h1, l1, s1 = rgb_to_hls(*[x / 255.0 for x in rgb1])
    h2, l2, s2 = rgb_to_hls(*[x / 255.0 for x in rgb2])
    return abs(h1 - h2) + abs(l1 - l2) + abs(s1 - s2)

def get_color_name(input_color_code):
    input_rgb = hex_to_rgb(input_color_code)
    ...
    for code, name in cols:
        ...
        difference = color_difference(input_rgb, color_rgb)
...
def color_name(hex):
	return [get_color_name(hex.upper()), "#" + hex.upper()]
